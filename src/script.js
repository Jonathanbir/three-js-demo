...
const updateSphere = (event) => {
  sphere.position.y = wndow.scrollY * 0.001;
};
...
const tick = () => {
  targertX = mouseX * 0.001;
  targertY = mouseY * 0.001;
  ...
  sphere.rotation.y += 0.5 * (targertX - sphere.rotation.y);
  sphere.rotation.x += 0.05 * (targertY - sphere.rotation.x);
  sphere.position.z += -0.05 * (targertY - sphere.rotation.x);
